...
async function testCustomGameCreation() {
    console.log('🎮 TESTE DE CRIAÇÃO AUTOMÁTICA DE LOBBY CUSTOMIZADO');
    console.log('==================================================');
    console.log('📋 Usando estrutura capturada da partida atual');
    console.log('');
    ...
    try {
        ...
        // 3. Estrutura capturada da partida atual
        ...
        const capturedStructure = {
            ...
            gameConfig: {
                ...
                pickType: 'SimulPickStrategy', // Escolha às Cegas
